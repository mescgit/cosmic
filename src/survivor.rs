...
pub struct Survivor {
    ...
    pub auto_weapon_equipped_glyphs: Vec<Option<GlyphId>>, 
}
...
impl Survivor {
    ...
    pub fn new_with_skills_and_items(
        ...
        let mut initial_auto_weapon_glyphs = Vec::new();
        if let Some(w_id) = initial_weapon_id {
            if let Some(w_def) = weapon_library.get_weapon_definition(w_id) {
                initial_auto_weapon_glyphs = vec![None; w_def.base_glyph_slots as usize];
            }
        }
        ...
        Self { 
            ...
            auto_weapon_equipped_glyphs: initial_auto_weapon_glyphs,
        } 
    } 
}
    ...
    for (survivor_transform, survivor_stats, mut sanity_strain, buff_effect_opt) in query.iter_mut() {
        ...
        if sanity_strain.fire_timer.just_finished() { 
            if survivor_stats.aim_direction != Vec2::ZERO { 
                ...
                let mut effective_projectile_lifetime_secs = weapon_def.projectile_lifetime_secs; // Start with weapon's base
                ...
                for i in 0..total_fragments { 
                    ...
                    spawn_automatic_projectile( 
                        ...
                        effective_projectile_lifetime_secs, // Use modified lifetime
                    ); 
                } 
            } 
        } 
