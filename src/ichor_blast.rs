...
use crate::{
    ...
    horror::HorrorProjectile, // Changed from enemy::EnemyProjectile
    survivor::Survivor,
...
fn ichor_blast_collision_system(
    ...
    mut enemy_query: Query<(Entity, &GlobalTransform, &mut Health, &crate::horror::Horror)>, // Changed from crate::enemy::Horror
